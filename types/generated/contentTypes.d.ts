...
export interface ApiHalfAnHourHalfAnHour extends Schema.CollectionType {
  collectionName: 'half_an_hours';
  info: {
    singularName: 'half-an-hour';
    pluralName: 'half-an-hours';
    displayName: 'Half_an_Hour';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::half-an-hour.half-an-hour': ApiHalfAnHourHalfAnHour;
